      ...
      <div className = {currentColor}>
        ...
        <section id = "about"> 
          <div className = "about"> 
            ...
            at McMaster University. Developing software is a huge passion of mine! I really enjoy learning 
            new programming languages and solving problems using code. I'm also very passionate about web 
            development, video game development, and AI! In my spare time I work on 
            ...
            <h1 data-aos= "fade-in" data-aos-duration="2000"> PROJECTS </h1>
              <div className = "container">
                ...
                <div className = "row">
                  ...
                  <div className = "col-lg">
                    <Project name = "COVID-AI"
                    date = "Feb. 2020 - Mar. 2020"
                    desc = "Web application created in a team of four that diagnoses COVID-19 using a machine-learning algorithm. User inputs responses to various questions within the web app, and is then suggested the best course of action based on the results of the machine learning algorithm. Web app was created using HTML, CSS, and JavaScript, and the machine-learning algorithm was made using IBM Watson."
                    img = {covidai}
                    imgName = "covidai"
                    logos = {[githubLogo]}
                    links = {["https://github.com/Zamzam95-coder/HackTheGlobe2020"]}
                    />
                  </div>
                </div>
